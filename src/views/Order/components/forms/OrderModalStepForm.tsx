...
import type { CreateOrderRef } from '@/views/Order/components/forms/OrderForm.tsx'
...
import { OrderForm } from '@/views/Order/components/forms/OrderForm.tsx'
...
export function OrderModalStepForm(props: OrderModalFormProps) {
      ...
      >
        {
          currentStep === 0 && (
            <LockedOrder.Provider value={submittedOrderData}>
              <OrderForm ref={createOrderRef} submitData={submittedOrderData} />
